...
public class PanelFormularios extends JPanel {
	...
	public PanelFormularios() {
		...
		lnlNombre.setBounds(10, 11, 73, 14);
		formularioCrear.add(lnlNombre);
		...
		lblDniBuscar = new JLabel("DNI de la persona: ");
		lblDniBuscar.setBounds(10, 11, 133, 14);
		formularioBuscar.add(lblDniBuscar);
		...
		lblDniBorrar = new JLabel("DNI de la persona");
		lblDniBorrar.setBounds(10, 11, 130, 14);
		formularioBorrar.add(lblDniBorrar);
